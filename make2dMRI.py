...
def make2dMRI(in_dir, out_dir, gt_provided = True, slice_no = 64, contrast_no = 0):
    ...
    dataset = LoadDatasetswClusterID(in_dir, data_transforms, {} , gt_provided=gt_provided, partial_file_names= files_list) # Loads as (case_info, data, clusterID), where data contains (x1, x2, x3, x4, segmentation)
